...
#define AI_NETWORK_MODEL_SIGNATURE     "0x6f663043714ed385b4aff56cb6fec64b"
...
#define AI_TOOLS_DATE_TIME   "2026-01-21T16:52:15+0100"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 16, 1, 5, 32), AI_STRIDE_INIT(4, 4, 64, 2048, 2048),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x0,
  AI_SHAPE_INIT(4, 3, 1, 5, 16), AI_STRIDE_INIT(4, 4, 12, 192, 192),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  24, 0x0,
  AI_SHAPE_INIT(4, 1, 3, 1, 128), AI_STRIDE_INIT(4, 4, 4, 12, 12),
...
AI_LAYER_OBJ_DECLARE(
  global_average_pooling1d_pool_layer, 6,
  POOL_TYPE, 0x0, NULL,
  pool, forward_ap,
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 53644, 1, 1),
    53644, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 9472, 1, 1),
    9472, NULL, NULL),
  ...
  &conv1d_conv2d_layer, 0xd8fb6864, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_1_output_array.data = AI_PTR(g_network_activations_map[0] + 3188);
    input_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3188);
    conv1d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 4724);
    conv1d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 4724);
    conv1d_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 4784);
    conv1d_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 4784);
    conv1d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 320);
    conv1d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 320);
    conv1d_1_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 4416);
    conv1d_1_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 4416);
    conv1d_1_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 4736);
    conv1d_1_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 4736);
    conv1d_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 4992);
    conv1d_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4992);
    conv1d_2_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 9088);
    conv1d_2_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 9088);
    conv1d_2_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    conv1d_2_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    conv1d_2_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    conv1d_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    global_average_pooling1d_pool_output_array.data = AI_PTR(g_network_activations_map[0] + 8192);
    global_average_pooling1d_pool_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8192);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv1d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 960);
    conv1d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 960);
    conv1d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 1024);
    conv1d_1_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1024);
    conv1d_1_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 11264);
    conv1d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 11264);
    conv1d_2_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_2_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 11392);
    conv1d_2_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 11392);
    conv1d_2_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_2_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 35968);
    conv1d_2_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 35968);
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 36224);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 36224);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 52608);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 52608);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 52864);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 52864);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 53632);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 53632);
    return true;
  }
